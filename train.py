...
from pathlib import *
os.environ["CUDA_VISIBLE_DEVICES"] = "1, 2 "  # 4和5
...
def train(args):
    model = nn.DataParallel(ERAFT(args, n_first_channels=args.num_voxel_bins).cuda(), device_ids=args.gpus)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='dsec_att_SENet', help="name your experiment")
    parser.add_argument('--dataset', type=str, default='../DSEC')
    ...
    parser.add_argument('--type', default='warm_start', help='warm_start or standard' )
